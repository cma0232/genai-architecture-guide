...
One model call
  ...
  → add multiple agents only when real specialization or boundaries justify it
```
...
> **Important distinction:** RAG, workflow, and agent are not mutually exclusive labels. You can build a deterministic RAG workflow, a RAG-enabled agent, or a multi-agent system that shares a retrieval service.
