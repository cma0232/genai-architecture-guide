...
> **Spec rule:** Every important requirement should map to evidence: a deterministic test, an eval case, an approval rule, an operational metric, or an audit event.
